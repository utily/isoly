...
export namespace CallingCode {
	export function is(value: any | CallingCode): value is CallingCode {
		return (
			typeof value == "string" &&
			value.length <= 5 &&
			(value == "+93" ||
	...
	export function from(country: Alpha2): CallingCode | undefined {
...
const alpha2toCallingCode: { [country in Alpha2]?: CallingCode | undefined } = {
	AF: "+93",
	AX: "+358",
	AL: "+355",
	DZ: "+213",
