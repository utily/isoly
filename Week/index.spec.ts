...
describe("isoly.Week", () => {
	...
	it.each([
		...
		"2020-W01",
		"2019-W01"
	] as const)("first -> from -> first for %s", week => expect(isoly.Week.from(isoly.Week.first(week))).toEqual(week))
	it.each([
		["2024-W01", "2023-W52"],
		["2023-W01", "2022-W52"],
		["2022-W01", "2021-W52"],
	...
	it.each([
		...
		"2020-W01",
		"2019-W01"
	] as const)("getWeek(%s)", (week, expected) => expect(isoly.Week.getWeek(week)).toEqual(1))
	it.each([
