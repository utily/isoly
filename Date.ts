...
// Representing year better creates to many options
// export type Date = `${number}-${
// 	| Exclude<
// 			`${`0${Exclude<Digit, "0">}` | `1${"0" | "1" | "2"}`}-${Exclude<`${"0" | "1" | "2"}${Digit}`, "00">}` | "30",
// 			"02-30"
// 	  >
...
export namespace Date {
	export const type = isly.named(
		"isoly.Date",
		isly.string<Date>(
			/^(((18|19|20|21|22)[0-9]{2}-(0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|(18|19|20)[0-9]{2}-(0[469]|11)-(0[1-9]|[12][0-9]|30)|(18|19|20)[0-9]{2}-(02)-(0[1-9]|1[0-9]|2[0-8])|(((18|19|20)(04|08|[2468][048]|[13579][26]))|2000)-(02)-29)$/
		)
	)
