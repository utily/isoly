...
export namespace Minute {
	...
	export const type = isly<Minute>("string", "value", ...values).rename("isoly.Time.Minute")
	...
	export namespace Numeric {
		...
		export const type = isly<Numeric>("number", "value", ...values).rename("isoly.Time.Minute.Numeric")
		export const is = type.is.bind(type) as typeof type.is
		export const flawed = type.flawed.bind(type) as typeof type.flawed
	}
